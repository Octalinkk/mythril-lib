...
You can read the changelog of the [latest version here](https://github.com/Octalinkk/mythril-lib/releases/tag/v0.1.3-beta).
...
## Installation
1. Download the [ZIP](https://github.com/Octalinkk/mythril-lib/releases/tag/v0.1.3-beta) and extract it 
2. Install the .apk

If you have any trouble installing the newer version or the app isn't acting properly, you might need to completly delete and re-install the app. For now, it's not a big deal but it'll be taken care of (i hope) for the first release.
